      ...
      >
        ...
        <div class="product-grid" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 15px;">
          <div 
            ...
            :key="product.id"
            class="product-card"
            style="padding: 15px; border: 1px solid #ddd; border-radius: 8px; background: #fff; box-shadow: 0 2px 8px rgba(0,0,0,0.1); display: flex; flex-direction: column; transition: transform 0.2s, box-shadow 0.2s;"
            @mouseover="$event.currentTarget.style.transform='translateY(-5px)'; $event.currentTarget.style.boxShadow='0 5px 15px rgba(0,0,0,0.2)'"
        ...
        <div v-if="items.length > 8" style="text-align: center; margin-top: 25px;">
          <button 
            ...
            style="padding: 12px 30px; background: #4CAF50; color: white; border: none; border-radius: 25px; font-size: 16px; font-weight: 600; cursor: pointer; transition: background 0.3s, transform 0.2s;"
            @mouseover="$event.target.style.background='#45a049'; $event.target.style.transform='scale(1.05)'"
            @mouseout="$event.target.style.background='#4CAF50'; $event.target.style.transform='scale(1)'"
          >
      ...
      <div style="margin-bottom: 20px;">
        ...
        <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
          ...
          <a 
            ...
            style="display: inline-flex; align-items: center; gap: 8px; padding: 12px 24px; background: #1877f2; color: white; text-decoration: none; border-radius: 25px; font-weight: 600; font-size: 16px; transition: transform 0.2s, box-shadow 0.2s;"
            @mouseover="$event.target.style.transform='translateY(-3px)'; $event.target.style.boxShadow='0 5px 15px rgba(24,119,242,0.4)'"
